...
public abstract class Package {
	...
	public String getCombinedContents() throws FileNotFoundException, IOException {
		...
		for( File file : files ) {
			...
			fileContents.append( "\n" );  // make sure there is a line break after each file, to account for any last line in the file that maybe has a double slash comment. Don't want that accidentally commenting out the first line of the next file!
		}
